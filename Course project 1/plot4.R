...
png(filename = "plot4.png",width = 480, height = 480)
  par(mfrow=c(2,2))
  plot(base2$Date2,base2$Global_active_power,type='l',xlab='',ylab='Global Active Power')
  plot(base2$Date2,base2$Voltage,type='l',xlab='datetime',ylab='Voltage')
  plot(base2$Date2,base2$Sub_metering_1,type='l',col='black',ylab='Energy sub metering',xlab='')
  ...
  plot(base2$Date2,base2$Global_reactive_power,type='l',xlab='datetime',ylab='Global_reactive_power')
dev.off()
